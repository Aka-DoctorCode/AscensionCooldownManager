...
local function EnsureDB()
    if type(AscensionTalentDB_V2) ~= "table" then
        AscensionTalentDB_V2 = {}
    end
    for k, v in pairs(DEFAULTS) do
        if AscensionTalentDB_V2[k] == nil then
            AscensionTalentDB_V2[k] = v
        end
    end
end
...
local function Log(msg, ...)
    if AscensionTalentDB_V2 and AscensionTalentDB_V2.debug then
        print("|cff00ccff[Ascension]|r:", msg, ...)
    end
end
...
-- Slash Commands
SLASH_ASCENSIONTALENTS1 = "/ats"
SLASH_ASCENSIONTALENTS2 = "/ascensiontalents"

SlashCmdList["ASCENSIONTALENTS"] = function(msg)
    local cmd = msg:lower()
    if cmd == "debug" then
    ...
    elseif cmd == "check" then
        ...
        print("Ascension: Checking talents...")
